...
namespace Maryar.Api.Services
{
    ...
    // Representa um item do carrinho passado pelo controller
    public class CartItemInfo
    {
        public string ProductId { get; set; }
        public int    Quantity  { get; set; }
        public int    WeightG   { get; set; }   // peso unitário em gramas
        public string BoxSizeCode { get; set; } // código da caixa mínima: P, M, G ou GG
    }

    // Dimensões de uma caixa (lidas do banco)
    ...
    public class CorreiosService
    {
        ...
        // Ordem dos tamanhos de caixa do menor para o maior
        ...
        // -------------------------------------------------------
        // Escolhe a caixa adequada para os itens do carrinho
        // -------------------------------------------------------
        public PackageInfo EscolherEmbalagem(List<CartItemInfo> itens, List<BoxSize> todasCaixas)
        {
            ...
            // Peso total = soma de (peso unitário × quantidade)
            int pesoTotalG = itens.Sum(i => i.WeightG * i.Quantity);

            // Caixa mínima exigida pelos produtos (maior código entre os itens)
            string codigoMinimoExigido = itens
                .Select(i => i.BoxSizeCode)
                .OrderByDescending(c => Array.IndexOf(OrdemCaixas, c))
                .First();

            // Encontra a menor caixa que:
            //   1. É >= ao tamanho mínimo exigido pelos produtos
            //   2. Suporta o peso total
        ...
        // -------------------------------------------------------
        // Autentica na API dos Correios (token cacheado por 1h)
        // -------------------------------------------------------
        ...
        // -------------------------------------------------------
        // Consulta preço de um serviço (SEDEX ou PAC)
        // -------------------------------------------------------
        ...
        // -------------------------------------------------------
        // Método principal — chamado pelo ShippingController
        // -------------------------------------------------------
            ...
            List<BoxSize> todasCaixas)
        {
            ...
            // Retorna do mais barato para o mais caro
