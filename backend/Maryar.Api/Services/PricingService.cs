...
namespace Maryar.Api.Services
{
    ...
    public static class PricingService
    {
        ...
        public static PricingResult Calculate(IEnumerable<CartItem> cartItems, IDictionary<System.Guid, Product> productsById)
        {
            ...
            foreach (var ci in cartItems)
            {
                ...
                // Preço autoritativo = preço corrente do produto no banco.
                var unit = p.Price;
